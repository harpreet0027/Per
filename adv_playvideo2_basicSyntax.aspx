<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="adv_playvideo2_basicSyntax.aspx.cs" Inherits="playvideo1" %>
...
<div>
    <asp:GridView ID="GridView1" runat="server" HeaderStyle-BackColor="#3AC0F2" 
        HeaderStyle-ForeColor="White" Width="516px" AutoGenerateColumns="false" 
        Height="143px">
        <Columns>
...
<center>
<h1><u> Python - CGI Programming</u></h1>
<table border="2">
